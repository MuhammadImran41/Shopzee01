...
@Component({
  ...
  styles: [`
    ...
    .dashboard-title { font-family:var(--font-heading); font-size:var(--text-4xl); font-weight:400; }
    .dashboard-date { font-size:var(--text-sm); color:var(--gray-400); }
    .kpi-grid { display:grid; grid-template-columns:repeat(4,1fr); gap:1rem; margin-bottom:1.5rem; @media(max-width:1100px){grid-template-columns:repeat(2,1fr);} }
    .kpi-card { background:var(--cream-light); border:1px solid var(--gray-200); padding:1.25rem; display:flex; gap:1rem; align-items:flex-start; transition:box-shadow 0.3s; &:hover{box-shadow:var(--shadow-gold);} }
    .kpi-icon { width:48px; height:48px; border-radius:var(--radius-sm); display:flex; align-items:center; justify-content:center; flex-shrink:0; &--gold{background:rgba(201,168,76,0.12);app-icon{color:var(--gold);}} &--black{background:rgba(26,26,26,0.08);app-icon{color:var(--black);}} &--green{background:rgba(76,175,80,0.12);app-icon{color:#388E3C;}} &--blue{background:rgba(33,150,243,0.12);app-icon{color:#1565C0;}} }
    .kpi-data { display:flex; flex-direction:column; gap:2px; }
    .kpi-value { font-family:var(--font-heading); font-size:1.625rem; font-weight:500; color:var(--black); }
    .kpi-label { font-size:0.75rem; color:var(--gray-400); letter-spacing:0.08em; text-transform:uppercase; }
    .kpi-change { font-size:0.75rem; display:flex; align-items:center; gap:2px; color:var(--gray-400); &.positive{color:#388E3C;} }
    .charts-row { display:grid; grid-template-columns:1fr 280px; gap:1rem; margin-bottom:1.5rem; @media(max-width:1100px){grid-template-columns:1fr;} }
    .chart-card { background:var(--cream-light); border:1px solid var(--gray-200); padding:1.25rem; &--wide{} }
    ...
    .period-btn { padding:0.25rem 0.625rem; font-size:0.75rem; background:none; border:1px solid var(--gray-200); cursor:pointer; transition:all 0.2s; &.active{background:var(--gold);border-color:var(--gold);color:var(--black);font-weight:600;} &:hover:not(.active){border-color:var(--gold);} }
    .bar-chart { display:flex; align-items:flex-end; gap:0.5rem; height:160px; padding-top:1.5rem; }
    .bar-wrap { flex:1; display:flex; flex-direction:column; align-items:center; gap:0.375rem; height:100%; }
    ...
    .bar-val { font-size:0.65rem; color:var(--gold-dark); font-weight:600; white-space:nowrap; margin-top:-1.2rem; }
    .bar-label { font-size:0.7rem; color:var(--gray-400); }
    .donut-chart { position:relative; width:140px; height:140px; margin:1rem auto; }
    .donut-svg { width:100%; height:100%; transform:rotate(-90deg); }
    .donut-center { position:absolute; inset:0; display:flex; flex-direction:column; align-items:center; justify-content:center; }
    .donut-total { font-family:var(--font-heading); font-size:1.75rem; font-weight:500; }
    .donut-sub { font-size:0.7rem; color:var(--gray-400); letter-spacing:0.1em; }
    .legend { display:flex; flex-direction:column; gap:0.5rem; margin-top:0.75rem; }
    .legend-item { display:flex; align-items:center; gap:0.5rem; font-size:0.8125rem; color:var(--gray-500); }
    .legend-dot { width:10px; height:10px; border-radius:50%; flex-shrink:0; }
    .bottom-row { display:grid; grid-template-columns:1fr 320px; gap:1rem; @media(max-width:1100px){grid-template-columns:1fr;} }
    .data-card { background:var(--cream-light); border:1px solid var(--gray-200); padding:1.25rem; overflow:hidden; }
    ...
    .admin-table { width:100%; border-collapse:collapse; font-size:0.8125rem; th{font-size:0.7rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:var(--gray-400);padding:0.5rem 0.75rem;border-bottom:1px solid var(--gray-200);text-align:left;} td{padding:0.75rem;border-bottom:1px solid var(--gray-200);color:var(--black);vertical-align:middle;} tr:last-child td{border-bottom:none;} tr:hover td{background:rgba(201,168,76,0.04);} }
    .order-id-cell { color:var(--gold-dark); font-weight:600; }
    .date-cell { color:var(--gray-400); white-space:nowrap; }
    .status-badge { padding:0.2rem 0.625rem; font-size:0.7rem; font-weight:700; letter-spacing:0.08em; text-transform:uppercase; }
    ...
    .tp-img { width:50px; height:65px; object-fit:cover; object-position:top center; flex-shrink:0; }
    .tp-info { flex:1; min-width:0; }
    .tp-name { font-size:0.8125rem; font-weight:500; display:block; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; margin-bottom:0.375rem; }
    ...
    .tp-sales { font-size:0.75rem; color:var(--gray-400); }
  `]
})
