      ...
      <div class="container">
        <div class="story-layout">
          <div class="story-text reveal-left">
            ...
            <p>Shopzee was founded with a singular vision — to bring the timeless beauty of Pakistani fashion to a modern audience. We believe that every thread tells a story, every embroidery carries heritage, and every garment deserves to be worn with pride.</p>
